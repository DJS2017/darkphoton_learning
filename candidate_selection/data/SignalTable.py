...
def Mass2(event, lund, index):
    if(abs(lund) == 211):
        return event['pienergy'][index]**2 - event['pip3'][index]**2
    elif(abs(lund) == 11):
        return event['eleenergy'][index]**2 - event['elep3'][index]**2
    elif(abs(lund) == 13):
        return event['muenergy'][index]**2 - event['mup3'][index]**2
...
if __name__ == '__main__':
    ...
    while(event != None):
        ...
        for candidate_id in range(nups):
            ...
            A1_lepton1_mass2 = Mass2(event, A1_lepton_lund, A1_lepton1_idx)
            #A1_lepton2_mass2 = Mass2(event, A1_lepton_lund, A1_lepton2_idx)
            A2_lepton1_mass2 = Mass2(event, A2_lepton_lund, A2_lepton1_idx)
            #A2_lepton2_mass2 = Mass2(event, A2_lepton_lund, A2_lepton2_idx)
            A3_lepton1_mass2 = Mass2(event, A3_lepton_lund, A3_lepton1_idx)
            #A3_lepton2_mass2 = Mass2(event, A3_lepton_lund, A3_lepton2_idx)
